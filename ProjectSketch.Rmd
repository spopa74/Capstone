...
## keep only 3 for each prior, the ones with the higher probability
...
So, with the accuracy measurements described above, I arrive to the following results on the test text (not involved in training - about 4 million words):  
  

    Type of test | Accuracy    
-----------------|----------------------------------------------------------------------------------
1-Gram 1  choice | 5%  (basically this model just counts the "the" words in the test vector)    
1-Gram 3 choices | 10%                                 (this time counts "the", "to", "and")    
2-Gram 1  choice | kjghkjgkj     
2-Gram 3 choices | hlkhljhkjhkj   
