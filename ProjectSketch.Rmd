...
* *What is the best set of features you might use to predict the next word?*
    ...
    * NOTE. the 4 and 5-grams will actually help a lot with the grammar as well, since most gramatical constructions will be well defined by 4 or 5 words expressions ("I .." is very often followed by a verb, etc). 
