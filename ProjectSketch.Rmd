...
------- | ---------------------------  
1-Gram  |  219.54     1.44     210.80   
2-Gram  |  840.21     3.73     823.12  
...
*...Understand frequencies of words and word pairs - build figures and tables to understand variation in the frequencies of words and word pairs in the data.*
  ...
  * 1-Grams:  
    * Total different: ~700,000
    * Highest frequency: ~3 millions
    * Number of 1's (frequency == 1): ~420,000
    * 6 Most used: "the", "and", "that", "for", "you", "with"  
  * 2-Grams:  
    * Total different: ~11 millions  
    * Highest frequency: ~300,000  
    * Number of 1's (frequency == 1): ~7.5 millions 
    * 6 Most used: "of the", "in the", "to the", "for the", "on the", "I'm"  
  * 3-Grams:  
    * Total different: ~32 millions  
    * Highest frequency: 30,000  
    * Number of 1's (frequency == 1): ~27 millions   
    * 6 Most used:  "I don't", "one of the", "a lot of", "thanks for the", "I can't", "it's a"
  * 4-Grams:  
    * Total different: ~48 millions  
    * Highest frequency: 5884  
    * Number of 1's (frequency == 1): ~45 millions    
    * 6 Most used: "can't wait to", "i don't know", "i'm going to", "the end of the", "the rest of the", "at the end of"
  * 5-Grams:  
    * Total different: ~53 millions  
    * Highest frequency: 2374
    * Number of 1's (frequency == 1): 51.7 millions (most of them are encountered only once)   
    * 6 Most used: "at the end of the", "can't wait to see", "i don't want to", "i can't wait to", "it's going to be", "in the middle of the"
...
**Questions**  
  ...
  * *How can you efficiently store an n-gram model (think Markov Chains)?*  As suggested, a Markov Chain could be employed. Starting with the list of 1-Grams (probabilities of one-word together with the list of one-words), I could start parsing the 2-Grams. F
...
'th word is already another stopword, so something that would come up higher anyway, with any of the 2/3/4-Gram models).     
  ...
  * *How can you use backoff models (http://en.wikipedia.org/wiki/Katz's_back-off_model) to estimate the probability of unobserved n-grams?* As mentioned above, if there is no suggestion for the last 4 words (using 5-Grams and associated probabilities), then use last 3, if not, last 2, if not, last 1, and, if still not, use the highest 1-Gram probabilities ("the", "end", etc).  
